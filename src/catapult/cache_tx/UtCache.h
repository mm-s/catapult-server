...
namespace catapult { namespace cache {
	...
	public:
		...
		/// Gets the weight of transactions an account with public \a key has placed into the cache.
		virtual uint64_t weight(const Key& key) const = 0;
