...
namespace catapult { namespace cache {
	...
	public:
		...
		/// Gets a vector of all unknown transaction infos in the cache that have a deadline at least \a minDeadline and
		/// do not have a short hash pair in \a knownShortHashPairs.
